...
export default function AdminDashboard() {
  ...
  const fetchAdminProfile = async () => {
    try {
      ...
      const response = await fetch(
        "http://hms-anas-backend.vercel.app/api/admin/profile",
        {
          headers: {
  ...
  const fetchTotalDoctors = async () => {
    try {
      ...
      const response = await fetch(
        "http://hms-anas-backend.vercel.app/api/admin/total-doctors",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchTotalPatients = async () => {
    try {
      ...
      const response = await fetch(
        "http://hms-anas-backend.vercel.app/api/admin/total-patients",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchDoctorOverview = async () => {
    try {
      ...
      const response = await fetch(
        "http://hms-anas-backend.vercel.app/api/admin/doctor-overview",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchPatientOverview = async () => {
    try {
      ...
      const response = await fetch(
        "http://hms-anas-backend.vercel.app/api/admin/patient-overview",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const renderAddDoctor = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await fetch(
          "http://hms-anas-backend.vercel.app/api/admin/add-doctor",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const renderAddAdmin = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await fetch(
          "http://hms-anas-backend.vercel.app/api/admin/add-admin",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
