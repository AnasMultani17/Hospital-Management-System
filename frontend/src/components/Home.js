    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Manage doctor profiles, schedules, and patient assignments.",
              },
              {
                icon: Calendar,
                title: "Appointment Scheduling",
                description:
                  "Streamline appointment booking and management for patients and doctors.",
              },
            ].map((card, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 text-left">
                Our hospital management system provides cutting-edge features to
                streamline your workflows, improve patient satisfaction, and
      ...
      <footer className="bg-white py-6 border-t">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <p className="text-gray-600">
            Created By Anas Multani & Karmit Langhnoda
          </p>
        </div>
      </footer>
    </div>
